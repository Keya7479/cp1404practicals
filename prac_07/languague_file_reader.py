...
def main():
    ...
    for line in in_file:
        ...
        # Arithmatic point is also stored as a string (Yes/No) and we want a Boolean
        arithmatic_pointer = parts[4] == "Yes"
        # Construct a ProgrammingLanguage object using the elements
        # year should be an int
        language = ProgrammingLanguage(parts[0], parts[1], reflection, int(parts[3]), arithmatic_pointer)
...
def using_namedtuple():
    ...
    Language = namedtuple('Language', 'name, typing, reflection, year, arithmatic_pointer')
    reader = csv.reader(in_file)  # use default dialect, Excel
